...
package repo_191205_01.segundo_job_0_1;
...
public class Segundo_Job implements TalendJob {
	static {System.setProperty("TalendJob.log", "Segundo_Job.log");}
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_lTVwYBc-Eeq0SuI1bTfT3g", "0.1");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_REPO_191205_01_Segundo_Job = new byte[0];
    static byte[] commonByteArray_REPO_191205_01_Segundo_Job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REPO_191205_01_Segundo_Job.length) {
				if(length < 1024 && commonByteArray_REPO_191205_01_Segundo_Job.length == 0) {
   					commonByteArray_REPO_191205_01_Segundo_Job = new byte[1024];
				} else {
   					commonByteArray_REPO_191205_01_Segundo_Job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REPO_191205_01_Segundo_Job, 0, length);
			strReturn = new String(commonByteArray_REPO_191205_01_Segundo_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REPO_191205_01_Segundo_Job) {
 ...
 */
	...
	currentComponent="tFixedFlowInput_1";
	    ...
	    for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
    	            		...
    	            		row1.mensaje = "Mensaje del Segundo job";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Segundo_Job.class.getClassLoader().getResourceAsStream("repo_191205_01/segundo_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Segundo_Job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
/************************************************************************************************
 *     44245 characters generated by Talend Cloud Big Data 
