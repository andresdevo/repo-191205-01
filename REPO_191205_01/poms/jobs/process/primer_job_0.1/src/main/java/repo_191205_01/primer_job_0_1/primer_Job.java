...
package repo_191205_01.primer_job_0_1;
...
public class primer_Job implements TalendJob {
	static {System.setProperty("TalendJob.log", "primer_Job.log");}
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "__gorEBc7EeqzRp0pqQ_DwA", "0.1");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_REPO_191205_01_primer_Job = new byte[0];
    static byte[] commonByteArray_REPO_191205_01_primer_Job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REPO_191205_01_primer_Job.length) {
				if(length < 1024 && commonByteArray_REPO_191205_01_primer_Job.length == 0) {
   					commonByteArray_REPO_191205_01_primer_Job = new byte[1024];
				} else {
   					commonByteArray_REPO_191205_01_primer_Job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REPO_191205_01_primer_Job, 0, length);
			strReturn = new String(commonByteArray_REPO_191205_01_primer_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REPO_191205_01_primer_Job) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = primer_Job.class.getClassLoader().getResourceAsStream("repo_191205_01/primer_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = primer_Job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
