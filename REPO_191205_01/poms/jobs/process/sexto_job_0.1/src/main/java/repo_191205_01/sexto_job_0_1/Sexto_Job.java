...
package repo_191205_01.sexto_job_0_1;
...
/**
 * Job: Sexto_Job Purpose: Sexto_Job<br>
 * Description: Sexto_Job <br>
 * 
 * @author andres.torres.mendoza@devoteam.com
 * @version 7.2.1.20190909_1200_patch
 * @status
 */
public class Sexto_Job implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Sexto_Job.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(Sexto_Job.class);
	...
	private final String jobName = "Sexto_Job";
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_pZaskBdMEeq3QrmWYMbgmg", "0.1");
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Sexto_Job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tRunJob_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tRunJob_1.append("PROCESS" + " = " + "Quinto_job");
							log4jParamters_tRunJob_1.append(" | ");
				...
				repo_191205_01.quinto_job_0_1.Quinto_job childJob_tRunJob_1 = new repo_191205_01.quinto_job_0_1.Quinto_job();
				// pass DataSources
				...
				log.info(
						"tRunJob_1 - The child job 'repo_191205_01.quinto_job_0_1.Quinto_job' starts on the version '0.1' with the context 'Default'.");

				String[][] childReturn_tRunJob_1 = childJob_tRunJob_1
						.runJob((String[]) paraList_tRunJob_1.toArray(new String[paraList_tRunJob_1.size()]));

				log.info("tRunJob_1 - The child job 'repo_191205_01.quinto_job_0_1.Quinto_job' is done.");
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tRunJob_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tRunJob_2.append("PROCESS" + " = " + "Tercer_Job");
							log4jParamters_tRunJob_2.append(" | ");
				...
				repo_191205_01.tercer_job_0_1.Tercer_Job childJob_tRunJob_2 = new repo_191205_01.tercer_job_0_1.Tercer_Job();
				// pass DataSources
				...
				log.info(
						"tRunJob_2 - The child job 'repo_191205_01.tercer_job_0_1.Tercer_Job' starts on the version '0.1' with the context 'Default'.");
				...
				log.info("tRunJob_2 - The child job 'repo_191205_01.tercer_job_0_1.Tercer_Job' is done.");
	...
	public static void main(String[] args) {
		final Sexto_Job Sexto_JobClass = new Sexto_Job();

		int exitCode = Sexto_JobClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Sexto_Job' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Sexto_Job' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Sexto_Job.class.getClassLoader()
					.getResourceAsStream("repo_191205_01/sexto_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Sexto_Job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Sexto_Job");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 48298 characters generated by Talend Cloud Big Data on the 5 de diciembre de
 * 2019 11:48:01 CET
 ************************************************************************************************/